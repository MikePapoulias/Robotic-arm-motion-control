...
g_be = [cos(pi) 0 sin(pi) 0 ; 0 1 0 0 ; -sin(pi) 0 cos(pi) 0.45 ; 0 0 0 1];
...
fprintf("Τransformation matrix g_oe in the initial position of the joint angles:/n");
g_oe = robot.fkine(q1).T
